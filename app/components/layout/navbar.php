<div class="py-2 pl-4 pr-2 bg-white flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
  ...
  <ul class="ml-auto flex items-center">
    <li class="text-gray-600 mr-4 font-medium"><?php echo $user->username ?></li>
    <li>
